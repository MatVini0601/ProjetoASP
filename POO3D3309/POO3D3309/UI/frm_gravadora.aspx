<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_gravadora.aspx.cs" Inherits="POO3D3309.UI.frm_gravadora" %>
    ...
    <form id="frm_grav" runat="server">
        <input type="checkbox" runat="server" id="check" checked>
            <header class="header" runat="server">
                ...
                <h3 class="logo" runat="server">Gravadora</h3>
            </header>
    ...
    <div class="background" runat="server">
        <div class="info" runat="server">
            ...
            <div class="row m-2" runat="server">
                 <div class="col-md-12">
                      <asp:Button ID="consulta" class="btn btn-block btn-outline-light btnConsulta" runat="server" Text="Inserir" OnClick="btnConsulta"/>
                 </div>                
            </div>
            ...
            <div class="row" runat="server">
                ...
                <div class="col-md-10">
                     <asp:GridView ID="GridGravadora" class="table table-dark table-striped" OnRowDeleting="DeleteRow" OnRowCancelingEdit="CancelEditing" OnRowEditing="EditingRow" OnRowUpdating="UpdatingRow" OnPageIndexChanging="PageIndexChanging" AllowPaging="True" PageSize="5" runat="server">
                          <Columns>
